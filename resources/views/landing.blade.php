                ...
                <div class="card">
                    <div class="card-body text-center">
                        <blockquote class="blockquote mb-0">
                            ...
                            <footer class="blockquote-footer"><cite title="Source Title" id="filmLevi">The Wizard of Oz, 1939</cite></footer>
                        </blockquote>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body text-center">
                        <blockquote class="blockquote mb-0">
                            ...
                            <footer class="blockquote-footer"><cite title="Source Title" id="filmDesni">The Godfather Part II, 1974</cite></footer>
                        </blockquote>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="card h-100" style="width: 18rem;">
                                    <img class="aktuelniSlike" src="{{ asset('img/insidious.jpg') }}" class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <div class="opisAktuelnih">
                                            <h5 class="card-title">Insidious</h5>
                                            <p class="card-text">Zakoracite u jezivu avanturu koja ce vas drzati na ivici stolice</p>
                                        </div>
                                        <a href="{{url('prikaziSveFilmove')}}" class="btn btn-primary">Rezervisite odmah</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="card h-100" style="width: 18rem;">
                                    <img class="aktuelniSlike" src="{{ asset('img/nottingHill.jpg') }}" class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <div class="opisAktuelnih">
                                            <h5 class="card-title">Notting Hill</h5>
                                            <p class="card-text">Opustite se i uzivajte u ovoj romanticnoj komediji koja je dostupna kod nas</p>
                                        </div>
                                        <a href="{{url('prikaziSveFilmove')}}" class="btn btn-primary">Rezervisite odmah</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="card h-100" style="width: 18rem; ">
                                    <img class="aktuelniSlike" src="{{ asset('img/blackAdam.jpeg') }}" class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <div class="opisAktuelnih">
                            ...
                            <div class="col-md-3">
                                <div class="card h-100" style="width: 18rem; ">
                                    <img class="aktuelniSlike" src="{{ asset('img/ironMan.jpg') }}" class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <div class="opisAktuelnih">
                                            <h5 class="card-title">Ironman</h5>
                                            <p class="card-text">Toni Stark je bogati egoista za koga sudbina ima zanimljiv plan.</p>
            ...
            <div class="col-md-4">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-primary" onclick="nasumicanFilm()" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                            Klikni me!!!
                        </button>
