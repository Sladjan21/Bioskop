        ...
        <div class="col-md-8 mt-5">
            <div class="card mt-5">
                <div class="card-body">
                    ...
                    <form action="{{url('skiniTXT')}}" method="POST" class="text-center">
                        @csrf
                        <fieldset>
                            <legend>Izabran film</legend>
                            <input class="form-control" type="text" value="{{$film[0]->NazivFilma}}" readonly name="nImeFilma" id="iImeFilma">
                        </fieldset>
                        <fieldset>
                            <legend>Broj karata</legend>
                            <input type="number" value="1" min="1" max="5" id="iKarte" name="nKarte" class="form-control">
                        ...
                        <fieldset>
                            <legend>Cena</legend>
                            <input type="text" readonly value="{{$film[0]->Cena}}" name="nCena" id="iCena" class="form-control">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="preuzimanjeTXT()" class="btn btn-success"><a href="">Rezervisi odmah</a></button>
            </div>
        </div>
    </div>
</div>
